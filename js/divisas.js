...
/* =========================================================
   ...
   =========================================================
   Cuando tengas tu token gratuito (solicítalo en https://tasas.eltoque.com/docs),
   pégalo abajo y pon ELTOQUE_API_ENABLED en true. La función ya está conectada:
   si la petición funciona, sustituye la tasa de referencia automáticamente al
   cargar la página; si falla (token vacío, CORS, sin red, endpoint distinto),
   no rompe nada: la página sigue funcionando con la tasa de referencia/manual.

   El endpoint exacto puede variar — confírmalo en la documentación oficial al
   recibir tu token y ajusta ELTOQUE_API_URL y el "parseo" si hace falta.
*/
var ELTOQUE_API_ENABLED = false;
var ELTOQUE_API_TOKEN = ""; // <-- pega aquí tu token cuando lo tengas
